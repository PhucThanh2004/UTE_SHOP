...
<c:url value="/assets/shop" var="URL"></c:url>
...
<link href="${URL}/vendor/fontawesome-free/css/all.min.css"
	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3">UTE Shop</div>
			</a>
			...
			<li class="nav-item"><a class="nav-link"
				href="${URL_PRIMARY}shop/product/list-product?id=${id}"> <i
					class="fas fa-fw fa-table"></i> <span>Danh sách sản phẩm</span></a></li>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">Shop của tôi</span> 
