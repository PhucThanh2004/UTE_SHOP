                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        ...
                        <img class="product__details__pic__item--large"
                             src="${pageContext.request.contextPath}/image?fname=${product.images[0]}" alt="">
                    </div>
                    <div class="product__details__pic__slider owl-carousel">
                        <c:forEach var="image" items="${product.images}">
                         <img data-imgbigurl="${pageContext.request.contextPath}/image?fname=${image}"
                             src="${pageContext.request.contextPath}/image?fname=${image}" alt="">
                        </c:forEach>
